...
contract Token {
    ...
    uint public totalSupply = 10000000e18; // 10 million Token
     ...
     */
    constructor(address account, string name_, string symbol_, uint8 decimals_, uint96 totalSupply_) public {
        name = name_;
        symbol = symbol_;
        decimals = decimals_;
